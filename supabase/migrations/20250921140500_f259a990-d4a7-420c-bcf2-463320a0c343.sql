-- Insert simplified test data with correct enum values
...
('Update CRM data', 'Clean up and update contact information in the database', 'pending', 'low', '2024-01-25 16:00:00', NULL, NULL, NULL, 'Remove duplicates and verify email addresses');
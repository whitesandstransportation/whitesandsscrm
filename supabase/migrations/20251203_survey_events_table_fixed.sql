...
DROP POLICY IF EXISTS "Users can view own survey events" ON survey_events;
DROP POLICY IF EXISTS "Users can insert own survey events" ON survey_events;
DROP POLICY IF EXISTS "Admins can view all survey events" ON survey_events;
